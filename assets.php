		...
		if ( $_FILES['icon']['error'] == 0  ) {
			...
			if ( $_FILES['icon']['error'] == 0 ) {
				...
				if ( in_array( 'iphone', $_POST['platforms'] ) || in_array( 'ipad', $_POST['platforms'] ) ) {
						...
						$assets_path_iphone = $assets_path . '/iphone/';
						echo $assets_path_iphone . $filename;
						$sizes[] = array( $assets_path_iphone . $filename, 160 );
						$sizes[] = array( $assets_path_iphone . str_replace('.','@2x.',$filename), 320 );
						$sizes[] = array( $assets_path_iphone . str_replace('.','@3x.',$filename), 480 ); 
				...
				if ( in_array( 'android', $_POST['platforms'] ) ) {
					...
					$assets_path_android = $assets_path . '/android/images/res-' . $android_prefix;

					$sizes[] = array( $assets_path_android . 'long-land-xxxhdpi/default.png',  640 );
					$sizes[] = array( $assets_path_android . 'long-land-xxhdpi/default.png', 480 );
					$sizes[] = array( $assets_path_android . 'long-land-xhdpi/default.png',  320 );
					$sizes[] = array( $assets_path_android . 'long-land-hdpi/default.png',  240 );
					$sizes[] = array( $assets_path_android . 'long-land-mdpi/default.png',  160 );
					$sizes[] = array( $assets_path_android . 'long-land-ldpi/default.png',  120 );

					$sizes[] = array( $assets_path_android . 'long-port-xxxhdpi/default.png',  640 );
					$sizes[] = array( $assets_path_android . 'long-port-xxhdpi/default.png',  480 );
					$sizes[] = array( $assets_path_android . 'long-port-xhdpi/default.png',  320 );
					$sizes[] = array( $assets_path_android . 'long-port-hdpi/default.png',  240 );
					$sizes[] = array( $assets_path_android . 'long-port-mdpi/default.png',  160 );
					$sizes[] = array( $assets_path_android . 'long-port-ldpi/default.png', 120 );

					$sizes[] = array( $assets_path_android . 'notlong-land-xxxhdpi/default.png',  640 );
					$sizes[] = array( $assets_path_android . 'notlong-land-xxhdpi/default.png',  480 );
					$sizes[] = array( $assets_path_android . 'notlong-land-xhdpi/default.png',  320 );
					$sizes[] = array( $assets_path_android . 'notlong-land-hdpi/default.png',  240 );
					$sizes[] = array( $assets_path_android . 'notlong-land-mdpi/default.png',  160 );
					$sizes[] = array( $assets_path_android . 'notlong-land-ldpi/default.png',  120 );

					$sizes[] = array( $assets_path_android . 'notlong-port-xxxhdpi/default.png', 320 );
					$sizes[] = array( $assets_path_android . 'notlong-port-xxhdpi/default.png',  320 );
					$sizes[] = array( $assets_path_android . 'notlong-port-xhdpi/default.png',  320 );
					$sizes[] = array( $assets_path_android . 'notlong-port-hdpi/default.png',  240 );
					$sizes[] = array( $assets_path_android . 'notlong-port-mdpi/default.png',  160 );
					$sizes[] = array( $assets_path_android . 'notlong-port-ldpi/default.png',  120 );
				}
